...
import { registerInstitution } from "../services/institutionService.js";
...
export function InstitutionAdminOnboarding() {
  ...
  const [step, setStep] = useState("account"); // "account" -> "institution"
        ...
        <div className="container-narrow">
          <div className="auth-card card">
            <div className="auth-header">
              <Link href="/institutions" className="back-link" style={{ marginBottom: "var(--space-6)" }}>
                ← Back to Institutions
              </Link>
              <div className="onboarding-path-icon" style={{ margin: "0 auto var(--space-4)" }}>
                <InstitutionIcon />
              </div>
              <h1 className="auth-title">Register as Institution Admin</h1>
              <p className="auth-subtitle">
                First, create your admin account. Then you'll register your institution.
              </p>
            </div>
            ...
            <form onSubmit={handleAccountSubmit} noValidate className="auth-form">
    ...
    <div className="report-page">
      <div className="container-narrow">
        <div className="auth-card card" style={{ maxWidth: "42rem" }}>
          <div className="auth-header">
            <Link href="/register-institution" className="back-link" style={{ marginBottom: "var(--space-6)" }} onClick={() => setStep("account")}>
              ← Back
            </Link>
            <div className="onboarding-path-icon" style={{ margin: "0 auto var(--space-4)" }}>
              <InstitutionIcon />
